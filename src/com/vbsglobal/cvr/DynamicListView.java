...
public class DynamicListView extends ListView {
    ...
    private void handleCellSwitch() {
        ...
        if (isBelow || isAbove) {
            ...
            swapElements(mNameList, originalItem, getPositionForView(switchView));
    ...
    public void setNameList(ArrayList<String> cheeseList) {
        mNameList = cheeseList;
        Log.d("cheeselist",""+cheeseList);
    }
    ...
    public List<String> getList()
    {
    	...
    	int length=((BaseAdapter) getAdapter()).getCount();
        Log.i("cheese list",""+length);
        return mNameList;
